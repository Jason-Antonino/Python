...
month_total = float(last23days + comp1 + subclins1)
...
# calculate bonus pay 1 (15th day of the current month)
bonuspay1 = sum(case_values[(last23days):(imonth_total)]) + (subclins1 - isubclins1) * case_values[(imonth_total)-1]
...
# calculate bonus pay 2 (last day of the current month)

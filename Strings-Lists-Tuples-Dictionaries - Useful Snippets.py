...
newlist1 = ''.join(map(str, list1)) #removes list formatting by converting the list to a string and then deleting the brackets and commas
newlist2 = ' '.join(map(str, list2)) #removes list formatting by converting the list to a string and then deleting the brackets and commas
print("")
